...
# 文件路径：tests/test_base_channel.py
#
# 这个文件的作用是什么？
# -------------------------
...
# 使用示例：
# --------
# pytest tests/test_base_channel.py -v  # 运行所有测试
# pytest tests/test_base_channel.py::test_chat_with_retry_retries_transient_error_then_succeeds -v  # 运行单个测试
# =============================================================================
